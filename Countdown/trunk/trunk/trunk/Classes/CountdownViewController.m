...
- (void)viewDidLoad {
    ...
    // getting current date and formatting
        ...
        NSString *arrivalDay = [[NSString alloc] initWithString:@"12/10/2011 9:35:00 PM"];
...
#define MONTH (30 * DAY)
        ...
        if ([currentDateString isEqualToString:@"11/07/2011"]){
            UIAlertView*alert = [[UIAlertView alloc]
                                 initWithTitle:@"10 MESES"
                                 message:@"abc"
                                 delegate:nil
                                 cancelButtonTitle:@"abc"
        ...
        // rule10: >14hour and <=1 days so = >50400 and <= 86400 seconds
            ...
            UIAlertView*alert = [[UIAlertView alloc]
                                 initWithTitle:@"So mais umas horinhas!"
