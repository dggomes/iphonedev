...
- (BOOL)textField2ShouldBeginEditing:
...
- (IBAction)dateChanged:(id)sender {
    ...
    self.userInputDate.text = [NSString stringWithFormat:@"%@", picker.date];
}
...
-(IBAction) showDate:(id)sender{
    ...
    NSDate *countDownTimePicker = [sender date];
    NSString *countDownDatePickerString = [dateformat stringFromDate:countDownDatePicker];
    NSString *countDownTimePickerString = [timeformat stringFromDate:countDownTimePicker];
    
    // printing strings for test
    
    userInputDate.text=countDownDatePickerString;
    userInputTime.text=countDownTimePickerString;
    
    // storing strings
    
    [[NSUserDefaults standardUserDefaults] setObject:currentDateString forKey:@"currentDateString"];
    [[NSUserDefaults standardUserDefaults] setObject:countDownTimePickerString forKey:@"countDownTimePickerString"];
